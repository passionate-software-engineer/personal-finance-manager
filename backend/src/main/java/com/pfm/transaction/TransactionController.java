...
public class TransactionController {
    ...
    public ResponseEntity<?> addTransaction(@RequestBody TransactionRequest transactionRequest) {
        ...
        Transaction transaction = new Transaction(null, transactionRequest.getDescription(), transactionRequest.getCategory(), transactionRequest.getPrice(), transactionRequest.getAccount());
