...
public class ControllerServiceTest {
  ...
  public void shoulAddCheckAndDeleteAccountTest() throws Exception {
    ...
    answer = restTemplate.exchange(servicePath() + "/" + accountId, HttpMethod.GET, entity, String.class);
    Assert.assertEquals(200, answer.getStatusCodeValue());
    answer = restTemplate.exchange(servicePath() + "/" + accountId, HttpMethod.DELETE, entity, String.class);
    Assert.assertEquals(200, answer.getStatusCodeValue());
  ...
  public void shoulAddUpdateAndDeleteAccountTest() throws Exception {
    ...
    answer = restTemplate.exchange(servicePath() + "/" + accountId, HttpMethod.PUT, entity, String.class);
    assertEquals(200, answer.getStatusCodeValue());
