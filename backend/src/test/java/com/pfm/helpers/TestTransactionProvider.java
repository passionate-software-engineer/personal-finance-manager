...
public class TestTransactionProvider {
  ...
  public static final Category MOCK_UPDATED_TRANSACTION_CATEGORY = new Category(1L, "groceries",
      null);
  public static final Account MOCK_TRANSACTION_ACCOUNT = new Account(1L, "ING BANK",
      BigDecimal.valueOf(1500));
  public static final Account MOCK_UPDATED_TRANSACTION_ACCOUNT = new Account(1L, "BGZ",
  ...
  public static final TransactionRequest transactionRequest = TransactionRequest.builder()
      .description(MOCK_TRANSACTION_DESCRIPTION).categoryId(CATEGORY_ID).accountId(ACCOUNT_ID)
      .price(MOCK_TRANSACTION_PRICE).build();
  public static final TransactionRequest transactionRequest1 = TransactionRequest.builder()
      .description(MOCK_UPDATED_TRANSACTION_DESCRIPTION).categoryId(CATEGORY_ID)
      .accountId(ACCOUNT_ID).price(MOCK_UPDATED_TRANSACTION_PRICE).build();
}
