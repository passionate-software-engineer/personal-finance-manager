...
public class ExportImportControllerIntegrationTest extends IntegrationTestsBase {
  ...
  public void shouldImportDataFromUserMarianToUserZdzislaw() throws Exception {
    ...
    mockMvc.perform(get(EXPORT_SERVICE_PATH)
        ...
        .andExpect(jsonPath("historyEntries[0].entries", hasSize(4)))
        ...
        .andExpect(jsonPath("historyEntries[0].entries[2].name", is("lastVerificationDate")))
        .andExpect(jsonPath("historyEntries[0].entries[2].newValue", containsString(currentDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")))))
        .andExpect(jsonPath("historyEntries[0].entries[3].name", is("archived")))
        .andExpect(jsonPath("historyEntries[0].entries[3].newValue", is("false")))
        ...
        .andExpect(jsonPath("historyEntries[3].entries", hasSize(4)))
        ...
        .andExpect(jsonPath("historyEntries[3].entries[2].name", is("lastVerificationDate")))
        .andExpect(jsonPath("historyEntries[3].entries[2].newValue", containsString(currentDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")))))
        .andExpect(jsonPath("historyEntries[3].entries[3].name", is("archived")))
        .andExpect(jsonPath("historyEntries[3].entries[3].newValue", is("false")))
